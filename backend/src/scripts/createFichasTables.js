/**
 * 📋 SCRIPT: Crear tablas de Fichas
 * 
 * Crea las tablas necesarias para el sistema de fichas
 */

require('dotenv').config();
const postgres = require('../config/postgres');

async function createFichasTables() {
  try {
    ...
    console.log('📋 Creando tablas de fichas...');
    ...
    console.log('\n✅ Todas las tablas de fichas han sido creadas exitosamente');
