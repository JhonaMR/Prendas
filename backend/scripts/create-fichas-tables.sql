-- ============================================
-- SCRIPT SQL: Crear tablas del sistema de fichas
-- ============================================
-- Ejecutar en PostgreSQL con: psql -U postgres -d inventory -f create-fichas-tables.sql
...
CREATE TABLE IF NOT EXISTS maletas (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    nombre VARCHAR(255) NOT NULL,
    correria_id VARCHAR(255) REFERENCES correrias(id),
    created_by VARCHAR(255),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
