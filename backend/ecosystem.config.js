  ...
  apps: [
    // ==================== PLOW ====================
    {
      ...
      env: {
        ...
        DB_SSL: 'false',
        CORS_ORIGIN: 'http://localhost:3000,http://localhost:5173,http://10.10.0.51:3000,http://10.10.0.51:5173,https://10.10.0.51:3000,https://10.10.0.51:5173,https://admin-plow.yersi.cc',
        HOST: '0.0.0.0',
        USE_HTTPS: 'true'
      },
    ...
    // ==================== MELAS ====================
    {
      ...
      env: {
        ...
        DB_CONNECTION_TIMEOUT: 5000,
        DB_SSL: 'false',
        CORS_ORIGIN: 'http://localhost:3001,http://localhost:5174,http://10.10.0.42:3001,http://10.10.0.42:5174,https://10.10.0.42:3001,https://10.10.0.42:5174,https://admin-melas.yersi.cc',
        HOST: '0.0.0.0',
        USE_HTTPS: 'true'
      },
