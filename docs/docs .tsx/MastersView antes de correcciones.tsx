          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <FormWrapper title={editingId ? 'Editar Confeccionista' : 'Nuevo Confeccionista'}>
                ...
                <div className="flex gap-4 mt-6">
                  <button onClick={handleSaveConfeccionista} className="px-10 py-4 bg-indigo-600 text-white font-black rounded-2xl shadow-lg hover:scale-105 transition-transform">GUARDAR CONFECCIONISTA</button>
                  {editingId && <button onClick={resetForms} className="px-6 py-4 bg-slate-100 text-slate-400 font-bold rounded-2xl">CANCELAR</button>}
                </div>
              </FormWrapper>
            </div>
