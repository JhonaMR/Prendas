        ...
        <div className="space-y-6 pb-20">
            ...
            {fichas.length === 0 ? (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                    {fichas.map(ficha => (
                        <button key={ficha.id} onClick={() => onNavigate('fichas-diseno-detalle', { referencia: ficha.referencia })}
                            className="group bg-white rounded-2xl border border-slate-200 hover:border-pink-300 hover:shadow-lg transition-all overflow-hidden text-left">
                ...
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2">Diseñadora</label>
