...
export const SIZES = ['S', 'M', 'L', 'XL', 'XXL', 'XXXL', 'U', '2-4', '6-8', '10-12', '14-16', 'Inventario'];
...
export const Icons = {
  ...
  ProductoEnProceso: () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 0 1-1.125-1.125M3.375 19.5h1.5C5.496 19.5 6 18.996 6 18.375m-3.75.125v-5.25A2.25 2.25 0 0 1 4.5 11.25h15a2.25 2.25 0 0 1 2.25 2.25v5.25m-18 0h18M3.375 4.5h17.25m-17.25 0a1.125 1.125 0 0 0-1.125 1.125M3.375 4.5h1.5C5.496 4.5 6 5.004 6 5.625m-3.75-.125v5.25A2.25 2.25 0 0 0 4.5 12.75h15a2.25 2.25 0 0 0 2.25-2.25V5.5m-18 0h18M6 5.625v12.75m12-12.75v12.75M9 9h6m-6 3h6m-6 3h6" />
    </svg>
  ),
  CalculoPago: () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
