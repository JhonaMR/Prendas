        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="flex-1 flex flex-col justify-center space-y-6 mb-8">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-slate-400 uppercase">Referencias en cero ({kpis.porcentajeCero.toFixed(0)}%)</p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-200 relative overflow-hidden group md:col-span-5 lg:col-span-3">
        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="mt-auto">
            ...
            <p className="text-[10px] font-bold text-blue-500 mt-2 uppercase">Cumplimiento: {kpis.porcentajeDespacho.toFixed(1)}%</p>
          </div>
        </div>
      </div>

      {/* Card 3 & 4: Resumen Financiero + Diferencia */}
