    ...
    <div className="h-full w-full flex flex-col bg-transparent p-6 md:p-10">
      <div className="mb-8 flex items-start justify-between">
        ...
        <button
          ...
          className="group relative h-12 md:h-14 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 md:px-6 flex items-center gap-2 transition-all duration-300 shadow-md hover:shadow-lg flex-shrink-0"
        >
